...
type proxyCmd struct {
	...
	NatsEmbedded           bool     `name:"" env:"NATS_EMBEDDED" default:"0" help:"Starts the proxy with an embedded NATS server"`
	NatsEmbeddedConfigPath string   `name:"" env:"NATS_EMBEDDED_CONFIG_PATH" default:"" help:"Configuration PATH with NATS options to be used when embedded mode is enabled"`
}
